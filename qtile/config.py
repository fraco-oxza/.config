...
from libqtile.config import Click, Drag, Group, Key, Screen, Match, EzKey
...
autostart = [
        "setxkbmap es",
        "feh --bg-fill /home/fraco/.wallpaper.webp",
        "picom --no-vsync &",
        "nm-applet &",
]
